                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                @if (auth()->user()->role === 'member')
                                    ...
                                    <a href="/dashboard/books" class="btn btn-sm btn-outline-primary">Explore</a>
                                @else
                                    <p class="mb-4">
                                    ...
                                    <a href="/dashboard/bookings" class="btn btn-sm btn-outline-primary">See Detail</a>
                                @endif
                                {{-- <p class="mb-4">
                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/unicons/bookings-icon.png') }}"
                                ...
                                <span class="d-block mb-1">Bookings</span>
                                @if (auth()->user()->role === 'member')
                    ...
                    <div class="col-3 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/unicons/denda-icon.png') }}" alt="Credit Card"
                                            class="rounded" />
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="cardOpt4" data-bs-toggle="dropdown"
                                ...
                                <span class="d-block mb-1">Forfeit</span>
                                @if (auth()->user()->role === 'member')
                    ...
                    <div class="col-3 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/unicons/active-icon.png') }}"
                                            alt="Credit Card" class="rounded" />
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="cardOpt4" data-bs-toggle="dropdown"
                                ...
                                <span class="d-block mb-1">Active Bookings</span>
                                @if (auth()->user()->role === 'member')
            ...
            <div class="col-md-6 col-lg-4 order-2 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Booking History</h5>
                        <div class="dropdown">
