            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card w-100 my-3">
                        <div class="card-header">
                            <h5 class="card-title fw-semibold m-3 sbtitle">Proceed Booking</h5>
                        </div>

                        <div class="card-body">
                            <div class="mb-4">
                                <label for="title" class="form-label">Change booking status for
                                    {{ $booking->user->name }}
                                </label>
                                ...
                                <form action="/dashboard/bookings/{{ $booking->id }}" method="post">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror"
                                        ...
                                        <option value="{{ 'Returned' }}"
                                            @if ($booking->status === 'Returned') selected @endif>
                                            Returned
                                        </option>
                                    </select>

                                    {{-- <input type="hidden" name="isDenda" value="{{ 0 }}"> --}}
                                    <button type="submit" class="btn btn-custom my-4" style="margin-right: 15px;">Update
                                        Booking Status
