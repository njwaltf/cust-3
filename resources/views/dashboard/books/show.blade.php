        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-lg-12 my-3">
                    <h2 class="sub-header1">Book Detail</h2>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    @if (auth()->user()->role === 'member' && $book->stock > 0)
                        <div class="col-lg-6 my-5">
                            <div class="card w-100">
                                <div class="card-header">
                                    <h5 class="card-title fw-semibold sbtitle">Interested to {{ $book->title }} ?</h5>
                                </div>
                                    ...
                                    <div class="row m-0">
                                        <div class="col-lg-5 m-0">
                                            <form action="/dashboard/bookings" method="POST">
                                                ...
                                                <button class="btn btn-custom" type="submit" style="margin-left: 5px;">Borrow</button>
                                            </form>
                                        </div>
                ...
                <div class="row my-3">
                    <div class="col-12">
                        <div class="card w-100">
                            <div class="card-header">
                                <h5 class="card-title fw-semibold m-3 sbtitle">Book Description</h5>
                            </div>
                            <div class="card-body p-3">
                                {!! $book->desc !!}
                            </div>
