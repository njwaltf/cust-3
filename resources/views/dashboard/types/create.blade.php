            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                    <div class="col-lg-12 my-3">
                        <h2 class="title2"><a href="/dashboard/types"><i class="ti ti-arrow-left"></i></a> Add new Category</h2>
                    </div>
                </div>
                ...
                <form action="/dashboard/types" method="post">
                    ...
                    <div class="row my-3">
                        <div class="col-lg-3">
                            <button type="submit" class="btn btn-custom" style="margin-right: 5px">Add Category<i
                                    class="ti ti-plus"></i></button>
                            <a href="/dashboard/types" class="btn btn-outline-warning">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
